    ...
    <div className="py-6 shadow-md">
      <div className="w-full max-w-base mx-auto bg-header-bg py-6 px-6 rounded-xl flex justify-between items-center">
        ...
        <div className="space-x-5">
          <button className="bg-main-bg px-6 py-3 rounded-lg font-medium text-sm">Sign In</button>
          <button className="bg-light-green px-6 py-3 rounded-lg font-medium text-sm">Sign Up</button>
        </div>
      </div>
    </div>
  );
